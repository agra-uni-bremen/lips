...
public abstract class MultipleLineLocator extends LineLocator {
	...
	/**
	 * Constructor that accepts a file object directly to read from.
	 *
	 * @param file File object that is passed to constructor of parent class.
	 * @throws IOException The specified file does not exist.
	 *
	 * @author lips Developers
	 */
	public MultipleLineLocator(File file) throws IOException {
		super(file);
	}
